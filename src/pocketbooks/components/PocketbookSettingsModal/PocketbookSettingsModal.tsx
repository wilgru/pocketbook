...
export const PocketbookSettingsModal = ({
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed top-[50%] left-[50%] h-[85vh] w-[92vw] max-w-180 translate-x-[-50%] translate-y-[-50%] overflow-y-scroll p-4 focus:outline-hidden bg-white border border-slate-300 rounded-2xl shadow-2xl ">
