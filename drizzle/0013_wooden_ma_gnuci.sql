...
INSERT INTO `__new_tasks`("id", "title", "description", "link", "links", "is_important", "noteId", "blocked_comment", "due_date", "completed_date", "cancelled_date", "blocked_date", "sort_order", "pocketbook", "created", "updated") SELECT "id", "title", "description", "link", "links", "is_important", "noteId", "blocked_comment", "due_date", "completed_date", "cancelled_date", "blocked_date", "sort_order", "pocketbook", "created", "updated" FROM `tasks`;--> statement-breakpoint
